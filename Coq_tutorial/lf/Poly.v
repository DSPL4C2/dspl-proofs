...
Proof.
  intros X l1 l2. induction l1 as [| h l1' IH].
  - reflexivity.
  - simpl. rewrite IH. reflexivity.
Qed.
(** [] *)
...
Proof. 
  intros X Y f l1 l2. induction l1 as [| h l1' IH].
  - reflexivity.
  - simpl. rewrite IH. reflexivity.
Qed. 
...
Proof.
  intros X Y f l. induction l as [| h l' IH].
  - reflexivity.
...
Definition there_isnt_even (l: list nat) : bool :=
  fold (fun n m => (oddb n) && m) l true. 

Example there_isnt_even1:
  there_isnt_even [1;3;5;7] = true.
Proof. reflexivity. Qed.

Example there_isnt_even2:
  there_isnt_even [] = true.
Proof. reflexivity. Qed.

Example there_isnt_even3:
  there_isnt_even [1;3;4;7] = false.
Proof. reflexivity. Qed.
...
(** **** Exercise: 2 stars, advanced (nth_error_informal)  
   ...
   Para o caso em que l = nil, temos que a igualdade é trivial.

   Para o caso e que l = h :: l', temos que pela definição de nth_error, temos
   que nth_error X l n = nth_error X l' pred n, que se resolve pela hipótese
   de indução.
*)
