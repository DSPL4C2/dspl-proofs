...
Proof.
  intros. unfold t_update. unfold eqb_string.
  destruct (string_dec x1 x2) eqn:H1.
  - destruct H. apply e.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  unfold t_update. unfold eqb_string. destruct (string_dec x x0) eqn:H.
  - reflexivity.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  intros x y. unfold eqb_string. destruct (string_dec x y) eqn:H.
